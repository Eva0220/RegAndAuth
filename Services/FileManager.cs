...
namespace InformBez.Services
{
    public class FileManager
    {
        ...
        public string FilePath => currentFilePath ?? Path.Combine(Folder, FileName);
        ...
        private string Folder
        {
            get
            {
                ...
                {
                    _folder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads", "EVA-IS");
                }
                return _folder;
            }
        }
